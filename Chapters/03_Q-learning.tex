...
If the atoms aren't uniform, we perform basic importance sampling (line \label{alg:cvartd:3}) to weight each 'sample' according to it's probability. \todo{is this valid IS?}. Finally, these ***samples*** are used to update the respective VaR and CVaR estimates.
