...
With the tweaked parameters, the algorithm both versions (baseline and visual) were able to converge and learned both the optimal expected value policy and the risk-sensitive policy. See \todo{video or something also atari of something ?} Note that the learning process was significantly more stable for the baseline procedure and the ***.
