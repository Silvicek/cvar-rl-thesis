...
Consider the following facts regarding the CVaR computation. Firstly, it is unimportant \emph{how} we compute $\cvar_y(Z(x, a))$ present in the CVaR Bellman operator \eqnref{tcvar}. Secondly, note that any discrete distribution has a piecewise linear $y\cvar_y$ function \cite{rockafellar2002conditional}, and this statement is two-sided: any a piecewise linear $y\cvar_y$ function can be seen as representing a certain discrete distribution.
