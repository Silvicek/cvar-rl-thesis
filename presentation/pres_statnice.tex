...
%    \begin{minipage}{0.45\textwidth}
%        \centering
%        \includegraphics[width=0.87\linewidth]{gfx/jp_morgan.jpg}
%        \caption{LOXM - online trader}
%    \end{minipage}\hfill
%    \begin{minipage}{0.45\textwidth}
%        \centering
%        \includegraphics[width=\linewidth]{gfx/data_center.jpg}
%        \caption{Google data centers: cooling}
%    \end{minipage}
%    \begin{itemize}
%    \item Advertising recommendations (Microsoft)
%    \item Dialog systems (Siri)
%    \end{itemize}
%\end{figure}
%
%\end{frame}
...
%
%$$\pi^* = \text{arg}\max_\pi \expect Z^\pi(x_0)$$
%\end{block}
%
%\end{frame}
...
%\begin{enumerate}
%\item Solutions should be \textbf{robust} to small environment changes
%\item Solutions should avoid catastrophic events and be \textbf{safe}
%\end{enumerate}
%\end{alertblock}
%
%\vspace{1cm}
...
%Instead of maximizing the expected return, focus on other criteria that take into account the \textbf{risk} of the potential reward.
%\end{exampleblock}
%
%\end{frame}
...
%%\item \$10 in 80\% cases and \$460 in 20\% cases
%\item \$1,000 in 10\% cases and \$0 in 90\% cases
%\end{enumerate}
%\end{example}
%\end{frame}
...
%\center
%\includegraphics[width=0.9\linewidth]{gfx/multivarvar3.pdf}
%\end{frame}
